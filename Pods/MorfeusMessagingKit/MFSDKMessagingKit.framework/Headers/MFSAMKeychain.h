...
/**
 Error code specific to MFSAMKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, MFSAMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	MFSAMKeychainErrorBadArguments = -1001,
};

/** MFSAMKeychain error domain */
extern NSString *const kMFSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const kMFSAMKeychainAccountKey;
 ...
 */
extern NSString *const kMFSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kMFSAMKeychainClassKey;

/** Item description. */
extern NSString *const kMFSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const kMFSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kMFSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kMFSAMKeychainWhereKey;
...
/**
 ...
 MFSAMKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface MFSAMKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in MFSAMKeychain.h for a list of keys that can be used when accessing the
...
//#import <MFSAMKeychain/MFSAMKeychainQuery.h>
